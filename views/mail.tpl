...
<tr><td>Mail To : <input type="text"  name="P_Email" style="width:150%" value={{','.join(str(e) for e in emails.values())}} disabled></td><br><tr>
<tr><td><input type="hidden" name="P_UID" value={{','.join(str(e) for e in emails.keys())}}><br></td><tr>
<tr><td>Subject<td></tr>
<tr><td><input type="text" name="subject" style="width:300%" maxlength="1000" style="height:25px;"></td></tr>
<tr><td>Message</td></tr>
<tr><td><TEXTAREA name="message" size="215" rows="10" " style="height:100px;width:300%"></TEXTAREA></td></tr>
